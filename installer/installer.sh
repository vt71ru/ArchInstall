...
installer_check_all_stages()
{
    ...
    do
        ...
        installer_check_stage "$stage" || return 1
...
installer_run_stage()
{
    ...
    #   rc=$?
    #
    # because the project uses set -e.
    #
...
installer_full_install()
{
    ...
    #
    # First verify every required stage.
    #
    ...
    do
        ...
        #
        # IMPORTANT:
        # Capture the real stage return code.
        #
